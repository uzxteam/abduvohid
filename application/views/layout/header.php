...
<html <?php echo $this->customlib->getRTL(); ?>>
 ...
 <?php
if ($this->config->item('SSLK') == "TeachIsland") {
    ?>
 <div class="topaleart">
    <div class="slidealert">
    <div class="alert alert-dismissible topaleart-inside"> 
   <p class="palert"><strong>Alert!</strong> You are using unregistered version of EDUX. Please <a  href="#" class="purchasemodal">click here</a> to register your purchase code for EDUX.</p>
</div></div>
</div>
                    <?php
}
