                            ...
                            <form action="<?php echo base_url(); ?>onlineadmission/paypal/checkout" method="post">
                                    ...
                                    <tr class="bordertoplightgray">
                                        ...
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td  bgcolor="#fff" class="text-right"> <button type="button"  name="search"  value="" class="btn btn-success"> <?php echo $this->lang->line('pay_with_paypal'); ?> <i class="fa fa fa-chevron-right"></i></button>  </td>
                                        </tr>
                                    </table>
